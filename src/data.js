...
export const ENEMY_ARCHETYPES = {
  emberFox: { id: 'emberFox', name: '잿불 여우', hp: 48, deck: ['C001', 'C002', 'C014', 'C021', 'C017'] },
  ironShell: { id: 'ironShell', name: '철갑 딱정벌레', hp: 58, deck: ['C006', 'C007', 'C015', 'C016', 'C022'] },
  gearSentinel: { id: 'gearSentinel', name: '기어 센티넬', hp: 62, deck: ['C004', 'C008', 'C015', 'C017', 'C022', 'C025', 'C029'] },
  thornDruid: { id: 'thornDruid', name: '가시 드루이드', hp: 66, deck: ['C003', 'C006', 'C011', 'C013', 'C024', 'C028'] },
