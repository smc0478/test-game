...
## 1) Design Goal
v2.6.1은 적 덱 구성 단계를 임시 운용 규칙으로 정리해 초반/중반/후반 전투 패턴 테스트를 빠르게 수행한다.
...
- 신규 공허 흡혈 컨셉 카드:
  ...
  - C034: `피의 계약` (코스트 0, 체력 4 지불 + 피해 13 + 흡혈 4)
  - C035: `결손 포식` (잃은 체력 x2 피해, 최대 24)
  - C036: `심연 송곳니` (이번 턴 공격마다 흡혈 2 + 드로우 1)
