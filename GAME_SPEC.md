...
## 1) Design Goal
v2.0.0은 **카드 풀 구조를 컨셉당 5장 고정(총 100장)으로 재편**한다.
...
- 시너지/버스트 밸런스 유지.
- 런 길이를 50라운드로 확장.
- 카드 풀을 C001~C100으로 재구성하고, 20개 컨셉당 5장 구조를 적용한다(모든 카드 이미지 포함).
...
- 카드 풀: 총 100장(C001~C100, 20개 컨셉 x 5장)
- 수치만 바꾸는 단순 카드(조건/부가효과 없음)는 최대 3장으로 제한
